...
$pdf->setFillColor(245, 245, 245);
	...
	$raw = $db->rawQuery("select m.*, p.*, k.* from mobil m, pelanggan p, kegiatan k where k.id_pelanggan=p.id_pelanggan and k.id_mobil=m.id_mobil and k.keluhan LIKE '%".$keluh."%'");
	foreach ($raw as $key) {
